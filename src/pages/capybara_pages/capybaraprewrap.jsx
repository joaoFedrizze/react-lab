...
dentro de elemento P`
    ...
    return (
        ...
        <div>
               ...
               <HeaderPaginator 
                preview="/capybaramultipleexpect"
                next="/capybarauploadfile"
               />
                ...
                <div className="main-container">
                    ...
                    <h1 className="ambiente-title">Arquivos e linhas de código</h1>
                        ...
                        <CodeBlock lines="9" lang="ruby" title="helloWorld.rb">
                            ...
                            <CodeEmptyLine/>
                            <CodeLine tab="1" code={`expect(textWrap_page).to have_selector('p', text: /Algum\s+texto\s+dentro de elemento P/)`} />
                            <CodeEmptyLine />
                            <CodeLine code="end" />
                        </CodeBlock>
